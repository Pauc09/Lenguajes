...
##### al ingresasr se encuentras 3 carpetas nombradas 'EXP1', 'EXP2', 'EXP3' dentro de cada una de ellas se encuentran los archivos referentes a cada gramatica es decir esta el .y y el .l para poder hacer la respectiva compilación.
